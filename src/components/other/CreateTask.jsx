...
function CreateTask() {
    ...
    const submitHandler = (e) => {
        ...
        setnewTask({taskTitle,taskDate,category,assignTO,description,active:false,newTask:true,failed:false,complete:false})
        ...
        <div className='bg-[#1c1c1c] rounded p-5 mt-8'>
            <form onSubmit={(e) => {
                ...
                <div className='w-2/5 flex flex-col items-start'>
                    ...
                    <textarea value={description} onChange={(e) => { setDescription(e.target.value) }} className='py-2 px-4 w-full
